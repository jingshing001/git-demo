...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\Users\\user\\Desktop\\bootStrap\\cartSelf",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
var _axios = _interopRequireDefault(require("./node_modules/axios"));
...
var cartTotalValue = document.querySelector('#cart-total-value');
...
function deleteItem(e) {
  ...
  var updatedProducts = products.filter(function (v) {
    return v.id !== parseInt(_this.dataset.id);
  });
...
function loadJSON() {
  ax.get('/furniture.json').then(function (response) {
    var html = '';
    response.data.forEach(function (v) {
      html += "\n                 <div class=\"col-md-6  col-xl-4  col-xxl-3 pt-2\">\n                        <div class=\"card\">\n                        \n                        <img src=\"".concat(v.imgSrc, "\" class=\"card-img-top\" alt=\"...\">\n                        \n                        <div class=\"card-body\">\n                       \n                        <h4 class=\"card-title\">").concat(v.name, "</h4>\n                        <p class=\"card-price\">TW$").concat(v.price, "</p>\n                        \n                        <button href=\"#\" class=\"btn btn-primary text-white cart-btn\">Add Cart</button>\n                            </div>\n                    </div>\n                    </div>\n                   ");
    });
...
function findCartInfo() {
  var products = getProductFromStorage();
  var total = products.reduce(function (pre, cur) {
    var price = parseInt(cur.price.substring(3));
    return pre += price;
  }, 0);
  return {
    total: total,
...
function loadCart() {
  ...
  products.forEach(function (v) {
    return createCartItem(v);
  });
  updateCartInfo();
}
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./node_modules/axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11467" + '/');
